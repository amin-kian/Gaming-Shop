...
export default function HeaderMobile({cartItemCount, navItems}) {

    return (
        <header
            className="w-full items-center justify-between px-4 py-4 grid grid-cols-3 bg-[#23252d] text-white">
            <MenuButton/>
            <Logo/>
